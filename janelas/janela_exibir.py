...
class ExibirVeiculo(ctk.CTkToplevel):
    def __init__(self,master=None):
        ...
        self.tabelaCarros.column('#0', width=0, strech=False)
        ...
        self.style.configure('Treeview', rowheight=40, font=('Opens Sans',12), foreground="#2b2b2b")
        self.style.configure('Treeview', background=[('selected','#144870')])
