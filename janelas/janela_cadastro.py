...
class CadastroVeiculo(ctk.CTkToplevel):
    def __init__(self,master=None):
        ...
        self.label_Titulo =ctk.CTkLabel(self.frameTitulo, text='Cadastrar Veículos',font=('Open Sans', 26,'bold'), text_color='white')
        ...
        self.btnCadastrar = ctk.CTkButton(self.frameItens, text='Cadastro', font=('Open Sans',16))
