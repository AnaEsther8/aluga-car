...
class AlugarVeiculo(ctk.CTkToplevel):
    def __init__(self , master=None):
        ...
        self.labelPlaca.grid(row=0,column=0,pady=(100,10) , sticky='w')
        ...
        self.labelModelo= ctk.CTkLabel(self.frameItens, text='Modelo:', font=('Opens Sans',16 , 'bold'))
        ...
        self.entryDataInicio = ctk.CTkEntry(self.frameItens, font=('Open Sans', 16), width=300, placeholder_text='dd/mm/aaaa')
        ...
        self.entryDataFim = ctk.CTkEntry(self.frameItens, font=('Open Sans', 16), width=300, placeholder_text='dd/mm/aaaa')
        self.entryDataFim.grid(row=3, column=3, padx=10, pady=10, sticky='w')

        self.botaoAlugar = ctk.CTkButton(self.frameItens, text='Alugar', font=('Opens Sans', 16, 'bold'))
